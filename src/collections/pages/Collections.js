...
const Collections = props => {
    ...
    useEffect(() => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/${collectionsType}/${auth.userId}`, {
            method: 'GET',
            headers: {
     ...
     ***********************************************************/
     ...
     const handleRemoveCollection = (id) => {
            ...
            fetch(`https://choice-champ-backend.vercel.app/collections/${collectionsType}/${auth.userId}/${id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
    ...
    const handleJoinCollection = () => {
        ...
        // Send a fetch post request to collections with the userId and the new collection name
        fetch(`https://choice-champ-backend.vercel.app/collections/join/${inputJoinRef.current.value}/${collectionsType}/${auth.userId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const moveLeft = (id) => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/moveLeft/${collectionsType}/${auth.userId}/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const moveRight = (id) => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/moveRight/${collectionsType}/${auth.userId}/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
