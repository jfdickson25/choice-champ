...
const Details = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/media/getInfo/${collectionType}/${itemId}`, {
            method: 'GET',
            headers: {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/collectionList/${collectionType}/${itemId}/${auth.userId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const addToCollection = (addCollectionId, index) => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/items/${addCollectionId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const removeFromCollection = (removeCollectionId, removeItemId) => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/items/${removeCollectionId}/${removeItemId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
