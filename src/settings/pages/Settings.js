                ...
                <div className='settings-home'>
                    <div className='settings-attribution'>
                        ...
                        <img 
                            ...
                            className='settings-attribution-logo' 
                        />
                        <p className='settings-attribution-text'>This product uses Board Game Atlas but is not endorsed or certified by Board Game Atlas. All board game data is provided by RAWG</p>
                        <img 
