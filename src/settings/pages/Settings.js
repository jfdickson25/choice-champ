                ...
                <div className='settings-home'>
                    <div className='settings-attribution'>
                        ...
                        <img 
                            ...
                            className='settings-attribution-logo' 
                        />
                        <p className='settings-attribution-text'>This product uses RAWG API but is not endorsed or certified by RAWG. All video game data is provided by RAWG</p>
                        <img 
                            src='https://s3-us-west-1.amazonaws.com/5cc.images/logos/social-image.jpg' 
                            className='settings-attribution-logo' 
                        />
                        <p className='settings-attribution-text'>This product uses Board Game Atlas but is not endorsed or certified by Board Game Atlas. All board game data is provided by Board Game Atlas</p>
                        <img 
