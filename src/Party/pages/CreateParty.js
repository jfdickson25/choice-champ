...
const CreateParty = props => {
    ...
    useEffect(() => {
        ...
        fetch(`https://choice-champ-backend.vercel.app/collections/movie/${auth.userId}`, {
            method: 'GET',
            headers: {
    ...
    const navToPartyWait = () => {
        ...
        fetch('https://choice-champ-backend.vercel.app/party', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const mediaTypeHandler = (type) => {
        ...
        // Make a fetch post request to collections with the userId and setCollections to the response
        fetch(`https://choice-champ-backend.vercel.app/collections/${type}/${auth.userId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
